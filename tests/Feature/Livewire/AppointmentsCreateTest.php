...
use App\Http\Livewire\AppointmentsCreate;
...
class AppointmentsCreateTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        Livewire::test(AppointmentsCreate::class)
            ->assertSeeInOrder([
                __('First Name'),
                __('Last Name'),
                __('Email'),
    ...
    public function test_validation()
    {
        ...
        Livewire::test(AppointmentsCreate::class)
            ...
            ->set('state.time', today()->addHours(9)->format('H:i A'))
    ...
    public function test_create_appointment()
    {
        ...
        $this->assertDatabaseHas('appointments', [
            ...
            'phone' => '123456789',
            'scheduled_at' => today()->addHours(9)->format('Y-m-d H:i:00')
        ]);
    }
}
